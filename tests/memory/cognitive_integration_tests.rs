...
/// Test fixture that returns a baseline memory value for comparison tests.
/// 
/// This is intentionally a constant value (100 MB) rather than actual system memory,
/// as tests verify relative memory changes, not absolute measurements.
