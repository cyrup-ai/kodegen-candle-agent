//! Shared utilities for candle-agent HTTP server examples
//!
//! This module spawns the local kodegen-candle-agent HTTP server and connects to it.
...
/// Connect to local candle-agent HTTP server
